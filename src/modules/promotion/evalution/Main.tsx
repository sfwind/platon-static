  ...
  componentWillMount() {
    ...
    practiceList.push(
      ...
      },
      {
        ...
        { subject: '找到这些用户私下交流，了解详细情况。', id: 1, point: 1, analysis:'好棒！经过澄清，你发现是因为他们在活动中的参与度低，而你没有顾及到。你和他们进行沟通，并寄了小礼品给他们，顺利解决了这次的小矛盾。' },
      ...
      },
      {
        ...
        choiceList: [
          ...
          { subject: '啊，我一定要好好写，不辜负老板的期望，先去和老板确定相关要求。', id: 2, point: 1, analysis:'好棒！机智如你，先和老板确定了相关的要求，再按照要求写总结，得到了老板的认可！' },
