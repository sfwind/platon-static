  ...
  render () {
    ...
    const renderComment = () => {
      return (
        <div className="comment-div">
          ...
          {filtered ? <div onClick={() => this.show(showAll)}
    ...
    return (
      <div key={id}
        ...
        <div className="comment-avatar"><img className="comment-avatar-img"
                                             src={avatar}/></div>
        <div className="comment-area">
          <div className="comment-head">
            ...
            {priority === 1 ?
              <div className="right">
                <AssetImg type="excellent_answer"
                          height={31}
                          width={32}
                          marginTop={-10}
                          marginRight={-10}/>
            ...
            }
            {
              del === 1 ?
                <div className="right">
                  <AssetImg url="https://static.iqycamp.com/images/fragment/comment_reply_del.png"
                            height={33}
                            width={40}
                            marginTop={-10}/>
                </div> : null
            ...
            <div className="function-area">
              {
                ...
                <div className="function-div"
                  ...
                  <Alert {...alertProps} show={show}>
                    <div className="global-pre"
                         dangerouslySetInnerHTML={{ __html: `确认要删除评论吗？` }}/>
                  </Alert>
                </div>
              }
              {
                ...
                <div className="function-div"
                  ...
                  <AssetImg type="reply"
                            height={12}
                            width={15}/>
                  <div className="function-button">回复</div>
                </div>
              }
            </div>
          }
