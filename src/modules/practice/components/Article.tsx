...
export default class Work extends React.Component<any,any> {
  ...
  render() {
    const {headImage, userName, content, submitUpdateTime,onEdit,voteCount,commentCount,voteStatus,onVoted,goComment,wordsCount=60,title} = this.props;
    ...
    return (
      <div className={`article article-other`} >
        <div className="submit-cell">
          <div className="submit-area">
            ...
            <div className="submit-title">{title}</div>
