  ...
  render() {
    ...
    return (
      <div>
        ...
        <Tutorial bgList={['http://www.iqycamp.com/images/fragment/rise_tutorial_gglx_0419.png']} show={isBoolean(openStatus.openConsolidation) && !openStatus.openConsolidation} onShowEnd={()=>this.tutorialEnd()}/>
      </div>
    )
  }
}
