        ...
        <div>
          ...
          <div className="discuss-container">
            <div className="discuss">
              ...
              {!_.isEmpty(discussList) && discussList.map((discuss, idx) => discussRender(discuss, idx))}
              {
    ...
    return (
      <div>
        <div className="warm-up-container has-footer">
          {knowledge && <div className="page-header">{knowledge.knowledge}</div>}
          {questionRender(data)}
          {showDiscuss && <div className="padding-comment-dialog"/>}
        </div>
        <div>
          {!showDiscuss && <div className="button-footer" onClick={this.back.bind(this)}>关闭</div>}
          {
            showDiscuss ?
