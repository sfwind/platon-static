...
知识产权</p>
            ...
            <p>3、圈外用户承诺不得以任何方式利用圈外直接或间接从事违反中国法律、以及社会公德的行为，圈外有权对违反上述承诺的内容予以删除。</p>
            <p>4、圈外用户不得利用圈外服务制作、上载、复制、发布、传播或者转载如下内容：</p>
            <p>· 反对宪法所确定的基本原则的；</p>
            ...
            <p>5、圈外有权对用户使用圈外的情况进行审查和监督，如用户在使用圈外时违反任何上述规定，圈外或其授权的人有权要求用户改正或直接采取一切必要的措施（包括但不限于更改或删除用户张贴的内容、暂停或终止用户使用圈外的权利）以减轻用户不当行为造成的影响。</p>
