      ...
      <div className="user-feedback-container">
        ...
        <div className="feedback-container">
          <div className="tip user-protocol">
            ...
            <p>未经相关权利人的明确书面授权，任何公司、媒体、网站及个人不得向任何自然人或单位提供营销、出售、出版，或出于播放或发布目的而改写或再发行，或者被用于其他任何商业目的。已经得到许可的，使用时必须注明“转载自圈外同学”。
              圈外同学不就由上述资料产生或在传送或递交全部或部分上述资料过程中产生的延误、不准确、错误和遗漏或从中产生或由此产生的任何损害赔偿, 以任何形式, 向用户或任何第三方负责。</p>

            <p className="q mg">知识产权</p>
