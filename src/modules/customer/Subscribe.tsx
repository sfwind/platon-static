  ...
  render() {
    ...
    return (
      <div className="container" style={{textAlign:'center'}}>
        <span style={{marginTop:'50px',display:'inline-block'}}>请先关注"圈外同学"公众号</span>
        <AssetImg url="https://static.iqycamp.com/images/serverQrCode.jpg" style={{width:'90%',height:'auto'}}/>
      </div>
    )
  }
}
