        ...
        return (
            <div className="description-page">
                <div className="container has-footer">
                    ...
                    <div className="context-img" onClick={(e)=>this.view(e)}><AssetImg url="http://www.iqycamp.com/images/fragment/difference1.jpg" width={'100%'}/></div>
                    ...
                    <div className="context-img" onClick={(e)=>this.view(e)}><AssetImg url="http://www.iqycamp.com/images/fragment/difference2.jpg" width={'100%'}/></div>
