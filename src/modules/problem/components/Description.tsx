        ...
        return (
            <div className="description-page">
                <div className="container has-footer">
                    <div className="context"><b>RISE不同版本的差别</b></div>
                    <div className="context-img" onClick={(e)=>this.view(e)}><AssetImg url="https://www.iqycamp.com/images/fragment/difference1.jpg" width={'100%'}/></div>
                    ...
                    <div className="context"><b>RISE的学习体系</b></div>
                    <div className="context-img" onClick={(e)=>this.view(e)}><AssetImg url="https://www.iqycamp.com/images/fragment/difference2.jpg" width={'100%'}/></div>
