  ...
  render() {
    ...
    return (
      <div className="self-init-component">
        <div onClick={() => {this.setState({ list: [] })}}>button</div>
        <h2>职业发展潜能测评</h2>
        <h4>测评简介</h4>
        职业发展潜能测评由华东师范大学教育教练<b>研究组</b>和<b>圈外同学</b>共同开发，通过4个维度、12个要素，帮助您全面评估职业能力与心理品质的现状，指导个人发展策略和计划。
        <AssetImg url='https://static.iqycamp.com/images/fragment/survey_self_pic_0428.png' width='65%'
                  style={{ display: 'block', margin: '0 auto' }}/>
        <h4>测评须知</h4>
        答案没有好坏、对错之分，为确保我们能够为你提供准确的发展建议，请提供最符合自己客观情况的回答。
        <VerticalStep list={list}/>
