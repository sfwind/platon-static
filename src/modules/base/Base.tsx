    ...
    const renderGlobalNotify = () => {
      if (showGlobalNotify) {
        if (expiredInSevenDays) {
          return <div onClick={() => this.handleClickGoRisePay()}
                      className="global-notify expire"/>;
        } else if (expired) {
          return <div onClick={() => this.handleClickGoRisePay()}
                      className="global-notify expired"/>;
        }
      }
    };
