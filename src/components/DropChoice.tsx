...
export default class DropChoice extends React.Component<any,any> {
  constructor(props) {
    ...
    this.topHeight = 300 / 560 * this.contentWidth
    ...
    this.closeTMB = 20 / 560 * this.contentWidth
  ...
  render() {
    ...
    return (
      <div className="screen-mask-container">
        ...
        <TweenOne style={{width:`${this.contentWidth}px`,marginTop:`${-this.contentHeight}px`}}
                  onChange={(e)=>this.onEnd(e)}
                  animation={{ y:this.state.close || this.state.submit? - window.innerWidth:this.contentHeight }}
                  component="div" className="content-container">
          <div className="top" style={{height:`${this.topHeight}px`}}>
            <div className="top-tips"
                 style={{height:90,lineHeight:`${this.topLineHeight}px`,fontSize:`${this.topFontSize}px`}}>
