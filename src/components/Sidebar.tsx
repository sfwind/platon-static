...
export class Sidebar extends Component {
  ...
  render() {
    const sidebarStyle = merge({}, defaultStyles.sidebar, this.props.styles.sidebar)
    const contentStyle = merge({}, defaultStyles.content, this.props.styles.content)
    const overlayStyle = merge({}, defaultStyles.overlay, this.props.styles.overlay)
    const useTouch = this.state.dragSupported && this.props.touch
    const isTouching = this.isTouching()
    const rootProps = {
      className: this.props.rootClassName,
      style: merge({}, defaultStyles.root, this.props.styles.root),
      role: 'navigation'
    }
    let dragHandle
    ...
    if(useTouch) {
      if(this.props.open) {
        ...
        const dragHandleStyle = merge({}, defaultStyles.dragHandle, this.props.styles.dragHandle)
    ...
    return (
      <div {...rootProps}>
        ...
        <div className={this.props.contentClassName} id={this.props.contentId} style={contentStyle}>
          {dragHandle}
          {this.props.children}
        </div>
      </div>
