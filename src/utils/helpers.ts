...
export function lockWindow () {
  ...
  document.body.addEventListener('mousewheel', preventWindowScroll);
  document.body.addEventListener('touchmove', preventWindowScroll);
}

export function unlockWindow () {
  document.body.style.overflow = 'auto';
  document.body.removeEventListener('mousewheel', preventWindowScroll);
  document.body.removeEventListener('touchmove', preventWindowScroll);
}
