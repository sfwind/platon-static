    ...
    res.status(200).json(
      {
        "msg": {
          ...
          "answerList": [ {
            ...
            "id": 83,
            "answer": "看到这个问题不禁会心一笑，很想说这个真的不只你一个人啊，现在大家都被手机绑架得很厉害。我想大约是因为人性本身是懒惰的吧～～能做到不看手机的，大约是两种人，一种是工作很忙碌，有很多重要且紧急的事情要做，一坐下就被各种邮件电话追杀忙到飞起，肯定是没有空来刷手机了；另外一种就是内心有明确的目标，动力强劲，所以可以突破惰性的吸引力（请脑补飞机起飞的场景～）<div><br></div><div>所以我觉得吧，我们要对抗的不是手机（也无法对抗，天性使然）。关键我们要想清楚，不看手机的时间，我们想干嘛。而我们想做的事，是想达成什么样的目标，对我们有多重要，能产生多大的动力来驱动我们改变自己。有了明确的目标和行动计划，然后培养习惯去执行，这样才能真正做到。具体怎么做，内容详见我们的课程<a data-problemid='12'>《如何改变自己》</a>，有非常细致的阐述和方法。</div><div><br></div><div>其实把手机放在我们看不见的地方，就是一个很好的方法，课程中《调整环境》一节会讲到。我打算开始采用。因为最近正好也在思考这个问题，想要提高自己的工作效率，打算试行一段时间看看效果:)</div>\n",
            "questionId": 33,
            "profileId": null,
            "approvalCount": 2,
