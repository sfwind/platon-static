...
router.get("/rise/practice/knowledge/start/*", (req, res) => {
  setTimeout(() =>
    res.status(200).json({
      "msg": [ {
        "id": 90,
        "knowledge": "分析、建立个人时间管理系统",
        "step": "诊断时间管理",
        "analysis": "打造真正属于自己的、最简单的时间管理系统，将理论转化为行动。",
        "means": "打造属于自己的极简时间管理系统，可以沿着以下路径：\n\n1）了解个人时间管理系统\n常态时间\n动态时间\n黄金时间\n碎片时间\n\n2）从这个角度分析时间流水，找出问题\n\n3）及时调整，将任务与四类时间做匹配，提高时间利用率",
        "keynote": "",
        "analysisPic": null,
        "meansPic": null,
        "keynotePic": null,
        ...
        "meansAudio": null,
        "keynoteAudio": null,
        "audio": "https://www.iqycamp.com/audio/knowledge_17_4_1.m4a",
        "audioWords": "通过以下行为分析模型，就能让你能够更加全面、精准地分析他人行为：\n1、解释系统（知）：是否清楚要做什么，以及相应要求？\n2、动力系统（愿）：了解要做什么之后，是否有意愿去做？\n3、能力系统（能）：具备了意愿，是否有足够的能力来完成？\n4、情境因素：是否有外部环境因素影响他人行为？",
        "appear": null,
        "example": {
          "id": 821,
          "question": "我们可以如何利用好自己黄金时间？",
          "type": 2,
          "analysis": "黄金时间，是指工作之外你最能够集中注意力的长段时间，因人而异，我们应该根据自身特点，找到自己效率最高的时间段。我们应该好好利用黄金时间做学习和自我提升等关键度高的事",
          "pic": null,
          "difficulty": 1,
          "knowledgeId": 90,
          "sceneId": 1,
          ...
          "sequence": 1,
          "example": true,
          "practiceUid": "T017G021A006L01001",
          "score": 0,
          "choiceList": [ {
            "id": 2524,
            "questionId": 821,
